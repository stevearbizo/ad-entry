...
isComplete() // hackiliscious way of ensuring the external resolve/reject are defined, but it can only complete once
...
function load() {
	...
	return new Promise((resolve, reject) => {
		...
		// images are loaded, resolve the load promise
